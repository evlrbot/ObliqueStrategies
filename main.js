...
"Your mistake was a hidden intention"
    ...
    Template.card2.rendered = function(){
	$('.front, .back').height($(".flip-container").height());
    }
    Template.horoscope.rendered = function() {
	//$('.back p').style('margin-top',-1*$('.back p').height()/2);
    }
    Template.card2.events = {
	'click .flip-container' : function() {
    ...
    Template.horoscope.horoscope = function(){
	return Session.get("horoscope");
    }
}
